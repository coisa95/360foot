...
export async function LeagueSidebar({ activeSlug }: LeagueSidebarProps) {
  ...
  return (
    <aside className="hidden lg:block fixed top-[65px] left-0 z-40 h-[calc(100vh-65px)] w-56 overflow-y-auto border-r border-dark-border bg-dark-bg scrollbar-thin scrollbar-track-transparent scrollbar-thumb-dark-border">
      <nav className="py-3">
        {groups.map((group) => (
