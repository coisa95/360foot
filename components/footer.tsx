          ...
          <div className="shrink-0">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              {process.env.NEXT_PUBLIC_WHATSAPP_URL && (
                <a
                  href={`${process.env.NEXT_PUBLIC_WHATSAPP_URL}?utm_source=360foot&utm_medium=cta&utm_campaign=footer-link`}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp Channel 360 Foot"
                  className="flex items-center justify-center w-7 h-7 rounded-full bg-emerald-50 hover:bg-emerald-100 transition-colors"
                >
                  <svg className="w-3.5 h-3.5 text-[#25D366]" fill="currentColor" viewBox="0 0 32 32">
