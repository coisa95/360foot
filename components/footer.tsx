        ...
        <div className="flex flex-col sm:flex-row items-start gap-6 sm:gap-12">
          ...
          <div className="shrink-0">
            ...
            <div className="mt-2 flex items-center gap-2">
              <a href="https://web.facebook.com/foot360news" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex items-center justify-center w-7 h-7 rounded-full bg-[#1877F2]/10 hover:bg-[#1877F2]/20 transition-colors">
