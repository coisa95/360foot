...
export const metadata: Metadata = {
  title: "Méthodologie — Production de contenus par l'IA",
  description:
  ...
  return (
    <main className="min-h-screen text-slate-900">
      <div className="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div className="mt-6">
          <h1 className="font-display text-3xl font-bold text-emerald-600">Notre methodologie</h1>
        ...
        <Card className="bg-transparent border-slate-200 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Sources de donnees</h2>
        ...
        <Card className="bg-transparent border-slate-200 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Generation de contenu par IA</h2>
          <Separator className="bg-slate-200 mb-4" />
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <div className="space-y-4">
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-slate-900">1. Collecte des donnees</h3>
            ...
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-slate-900">2. Analyse et contextualisation</h3>
              <p className="text-slate-500 text-sm mt-1">
            ...
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-slate-900">3. Redaction</h3>
              <p className="text-slate-500 text-sm mt-1">
            ...
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-slate-900">4. Controle qualite</h3>
              <p className="text-slate-500 text-sm mt-1">
        ...
        <Card className="bg-transparent border-slate-200 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Controle qualite</h2>
          <Separator className="bg-slate-200 mb-4" />
          <p className="text-slate-700 leading-relaxed mb-4">
        ...
        <Card className="bg-transparent border-slate-200 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Transparence</h2>
          <Separator className="bg-slate-200 mb-4" />
