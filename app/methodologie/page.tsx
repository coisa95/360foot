  ...
  return (
    <main className="min-h-screen text-white">
      <div className="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div className="mt-6">
          <h1 className="font-display text-3xl font-bold text-emerald-400">Notre methodologie</h1>
        ...
        <Card className="bg-transparent border-gray-800 p-6 mt-6">
          ...
          <div className="space-y-4">
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-white">1. Collecte des donnees</h3>
            ...
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-white">2. Analyse et contextualisation</h3>
              <p className="text-gray-400 text-sm mt-1">
            ...
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-white">3. Redaction</h3>
              <p className="text-gray-400 text-sm mt-1">
            ...
            <div className="border-l-2 border-emerald-400 pl-4">
              <h3 className="font-display font-bold text-white">4. Controle qualite</h3>
              <p className="text-gray-400 text-sm mt-1">
