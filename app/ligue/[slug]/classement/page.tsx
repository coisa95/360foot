                  ...
                  >
                    ...
                    <td className="p-3">
                      <div className="flex items-center gap-2">
                        {row.team_logo && (
                          <img src={row.team_logo} alt={row.team_name} className="w-5 h-5 object-contain" />
                        )}
                        {teamSlug ? (
                          <Link href={`/equipe/${teamSlug}`} className="font-medium hover:text-lime-400 transition-colors">
                            {row.team_name}
                          </Link>
                        ) : (
