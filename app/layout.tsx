  ...
  return (
    <html lang="fr" className={cn("font-sans antialiased", geist.variable, inter.variable, syne.variable)}>
      <head>
        ...
        {/* hreflang explicit — Next.js ne rend pas les `alternates.languages`
            quand toutes les locales pointent vers la même URL. On les rend
            manuellement pour signaler à Google la couverture multi-pays
            francophones. */}
        <link rel="alternate" hrefLang="fr" href="https://360-foot.com" />
        <link rel="alternate" hrefLang="fr-FR" href="https://360-foot.com" />
        ...
        <link rel="alternate" hrefLang="fr-CD" href="https://360-foot.com" />
        <link rel="alternate" hrefLang="fr-MA" href="https://360-foot.com" />
        <link rel="alternate" hrefLang="fr-TN" href="https://360-foot.com" />
