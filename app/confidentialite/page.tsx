...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    images: ["https://360-foot.com/api/og?title=Politique%20de%20confidentialit%C3%A9"],
  },
  twitter: {
  ...
  return (
    <main className="min-h-screen text-white">
      <div className="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div className="mt-6">
          <h1 className="font-display text-3xl font-bold text-emerald-400">Politique de confidentialité</h1>
        ...
        <Card className="bg-transparent border-gray-800 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Données collectées</h2>
          <Separator className="bg-gray-800 mb-4" />
        ...
        <Card className="bg-transparent border-gray-800 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Utilisation des données</h2>
          <Separator className="bg-gray-800 mb-4" />
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <Card className="bg-transparent border-gray-800 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Cookies</h2>
          <Separator className="bg-gray-800 mb-4" />
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <Card className="bg-transparent border-gray-800 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Liens d&apos;affiliation</h2>
          <Separator className="bg-gray-800 mb-4" />
          <p className="text-gray-300 leading-relaxed">
        ...
        <Card className="bg-transparent border-gray-800 p-6 mt-6">
          <h2 className="font-display text-xl font-bold mb-4">Vos droits</h2>
          <Separator className="bg-gray-800 mb-4" />
          <p className="text-gray-300 leading-relaxed mb-4">
